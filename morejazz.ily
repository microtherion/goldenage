#(define-markup-command (acMin layout props extension) (markup?)
  (interpret-markup layout props
    (markup #:fontsize -2 "m" #:super extension)))

#(define-markup-command (acMaj layout props extension) (markup?)
  (interpret-markup layout props
    (markup #:super (#:fontsize 3 (#:translate-scaled (cons 0 -0.7) "Δ")) #:super extension)))

#(define-markup-command (acMinMaj layout props extension) (markup?)
  (interpret-markup layout props
    (markup #:fontsize -2 "m" #:super (#:fontsize 3 (#:translate-scaled (cons 0 -0.7) "Δ")) #:super extension)))
...
% Use a triangle to represent Maj7 chords, not capital M
  <c e g b>-\markup { \acMaj \null } % :maj
  <c e ges b>-\markup { \acMaj #"7(ı5)" } % :maj.5-
